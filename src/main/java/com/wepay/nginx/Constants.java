...
public class Constants {
	...
	public static final String DIRECTIVE_PRINT_FORMAT = TAB_SPACE + "%-{0}s %s" + SEMICOLON + NEWLINE;// ex:
																										// "
																										// dir_name
																										// /etc/nginx/*;"
	public static final String DIRECTIVE_IP_PRINT_FORMAT = TAB_SPACE + "%s" + SEMICOLON + NEWLINE;// ex:
																									// "
																									// dir_name
																									// /etc/nginx/*;"
	public static final String DIRECTIVE_PRINT_FORMAT_CONDITION = TAB_SPACE + "%s" + NEWLINE + DIRECTIVE_PRINT_FORMAT
			+ TAB_SPACE + "%s" + NEWLINE;
	...
	public static final String NAMED_CONTEXT_PRINT_FORMAT = TAB_SPACE + "%s" + SPACE + "%s {" + NEWLINE + "%s"
			+ TAB_SPACE + "}" + NEWLINE;
}
