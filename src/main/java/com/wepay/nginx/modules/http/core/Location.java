...
import com.wepay.nginx.modules.http.api.*;
...
import com.wepay.nginx.modules.http.empty.gif.*;
import com.wepay.nginx.modules.http.f4f.*;
import com.wepay.nginx.modules.http.fastcgi.*;
import com.wepay.nginx.modules.http.flv.*;
...
import com.wepay.nginx.modules.http.random.index.*;
...
import com.wepay.nginx.modules.http.upstream.conf.*;
...
public class Location extends NamedAbstractContext {
	...
	@JsonProperty("empty_gif")
	private EmptyGif emptyGif;
	...
	@JsonProperty("fastcgi_params")
	private FastcgiParams fastcgiParams;

	@JsonProperty("fastcgi_pass")
	private FastcgiPass fastcgiPass;
	...
	@JsonProperty("fastcgi_split_path_info")
	private FastcgiSplitPathInfo fastcgiSplitPathInfo;
	...
	@JsonProperty("limit_except")
	private LimitExcept limitExcept;
	...
	@JsonProperty("scgi_pass")
	private ScgiPass scgiPass;
	...
	@JsonProperty("secure_link_secret")
	private SecureLinkSecret secureLinkSecret;
	...
	@JsonProperty("upstream_conf")
	private UpstreamConf upstreamConf;
	...
	@JsonProperty("uwsgi_pass")
	private UwsgiPass uwsgiPass;
	...
	@JsonProperty("xslt_stylesheet")
	private XsltStylesheet xsltStylesheet;
	...
	public void populateMap() {
		...
		map.put("fastcgi_params", fastcgiParams);
		map.put("fastcgi_pass", fastcgiPass);
		...
		map.put("fastcgi_split_path_info", fastcgiSplitPathInfo);
		...
		map.put("image_filter", imageFilter);
		...
		map.put("limit_except", limitExcept);
		...
		map.put("random_index", randomIndex);
		...
		map.put("secure_link_secret", secureLinkSecret);
		...
		map.put("upstream_conf", upstreamConf);
		...
		map.put("xslt_stylesheet", xsltStylesheet);
		map.put("xslt_types", xsltTypes);
	}

	public LocationName getUrl() {
		return url;
	}

	public void setUrl(LocationName url) {
		this.url = url;
	}
